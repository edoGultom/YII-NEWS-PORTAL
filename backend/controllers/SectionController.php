...
class SectionController extends Controller
{
    ...
    public function actionIndex($id_kategori = null)
    {
        ...
        if (isset($id_kategori)) {
            $dataProvider->query->andFilterWhere(['id_kategori' => $id_kategori])->orderBy(['created_at' => SORT_DESC]);
        }
        $kategori = \common\models\SectionKategori::find()->all();
        $kategori = ArrayHelper::map($kategori, 'id', 'keterangan');
