                            ...
                            <div class="inner-box">
                                <div class="single-item-carousel owl-carousel owl-theme">
                                    <div class="image">
                                        ...
                                        <div class="category">
                                            <a
                                                href="<?= Url::to(['/news/' . $value->sub_judul]) ?>"><?= $value->kategoriArtikel->keterangan ?? '-' ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="lower-box">
                                    <h3>
                                        <a
                                            href="<?= Url::to(['/news/' . $value->sub_judul]) ?>"><?= $value->judul ?></a>
                                    </h3>
                                    <ul class="post-meta">
                                        <li><span
                                                class="icon fa fa-clock-o"></span><?= date("d-m-Y", substr($value->created_at, 0, 10)) ?>
                                        </li>
                                    </ul>
